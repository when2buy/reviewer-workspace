...
PR: [https://github.com/QF-Bench/QuantitativeFinance-Bench/pull/77](https://github.com/QF-Bench/QuantitativeFinance-Bench/pull/77)
...
File: [`instruction.md`](https://github.com/QF-Bench/QuantitativeFinance-Bench/blob/4e16740/tasks/cds-curve-stripping/instruction.md)
...
```
E       assert np.False_
E        +  where np.False_ = <function isclose at 0x7f17ae8e6c30>(0.007568610973028443, 0.001869, atol=0.0005)
E        +    where <function isclose at 0x7f17ae8e6c30> = np.isclose
E       assert np.False_
E        +  where np.False_ = <function isclose at 0x7f17ae8e6c30>(0.012759484496348162, 0.003291, atol=0.0005)
E        +    where <function isclose at 0x7f17ae8e6c30> = np.isclose
E       assert np.False_
E        +  where np.False_ = <function isclose at 0x7f17ae8e6c30>(0.01777679204218927, 0.004712, atol=0.0005)
```
...
```
E       assert np.False_
E        +  where np.False_ = <function isclose at 0x7fa02e526a30>(0.007566825695684495, 0.001869, atol=0.0005)
E        +    where <function isclose at 0x7fa02e526a30> = np.isclose
E       assert np.False_
E        +  where np.False_ = <function isclose at 0x7fa02e526a30>(0.013177881304403144, 0.003291, atol=0.0005)
E        +    where <function isclose at 0x7fa02e526a30> = np.isclose
E       assert np.False_
E        +  where np.False_ = <function isclose at 0x7fa02e526a30>(0.018117681393520713, 0.004712, atol=0.0005)
```
