...
PR: [https://github.com/QF-Bench/QuantitativeFinance-Bench/pull/132](https://github.com/QF-Bench/QuantitativeFinance-Bench/pull/132)
...
File: [`tests/test_outputs.py`](https://github.com/QF-Bench/QuantitativeFinance-Bench/blob/ccfb0b5/tasks/dirty-gap-momentum-aapl/tests/test_outputs.py)
...
File: [`task.toml`](https://github.com/QF-Bench/QuantitativeFinance-Bench/blob/ccfb0b5/tasks/dirty-gap-momentum-aapl/task.toml)
