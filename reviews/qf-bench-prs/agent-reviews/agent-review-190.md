# Review: PR #190 — ewma-correlation-sensitivity
Reviewer: Agent (automated) | Date: 2026-04-26

## What This PR Does
EWMA correlation matrix sensitivity analysis. Agent must implement the financial model from scratch based on instruction, produce specified output files, and pass verifier tests.

## Trial Evidence
- **Haiku 4.5:** ✅ 22/22 (reward=1.0) — full pass
- **Sonnet 4.5:** Pending
- **Opus 4.6:** Pending
